...
struct ContentView: View {
    ...
    private var tabs: [FloatingTabBarItem] {
        var items: [FloatingTabBarItem] = [
            .init(id: 0, title: "Chat", systemImage: "bubble.left.and.text.bubble.right", badge: chatTabBadge),
        ]
        if featureGroupView {
        ...
        items.append(.init(id: 1, title: "Home", systemImage: "house"))
        items.append(.init(id: 4, title: "Album", systemImage: "photo.on.rectangle"))
        items.append(.init(id: 2, title: "Settings", systemImage: "gearshape"))
        return items
    }
