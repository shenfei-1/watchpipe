        ...
        GeometryReader { geo in
            ZStack(alignment: .bottom) {
                Image("Splash")
                    ...
                    .clipped()
                VStack(spacing: 10) {
                    // 珩 2026-09-06：她要细的花体——Cormorant Garamond 细斜体
                    Text("Lamp")
                        .font(.custom("CormorantGaramond-LightItalic", size: 64))
                        .foregroundStyle(ink)
                        .tracking(3)
                    Text("the lamp is on")
                        .font(.custom("CormorantGaramond-MediumItalic", size: 19))
                    ...
                    Button(action: onEnter) {
                        Text("Enter")
                            .font(.custom("CormorantGaramond-Medium", size: 21))
                            .tracking(3)
